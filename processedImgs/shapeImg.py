...
if __name__ == '__main__':    
    processing_jobs = [
        {
            "job_name": "Top Images",
            "input_dirs": [
                "box crop top/damaged_top_cropped_and_no_bg",
                "box crop top/intact_top_cropped_and_no_bg",
            ],
            "output_simple": "processedImgs/top/simple_resize",
            "output_proportional": "processedImgs/top/proportional_resize"
        },
        {
            "job_name": "Side Images",
            "input_dirs": [
                "box crop side/damaged side_cropped_no_bg",
                "box crop side/intact side_cropped_no_bg",
            ],
            "output_simple": "processedImgs/side/simple_resize",
            "output_proportional": "processedImgs/side/proportional_resize"
        }
    ]
    ...
    for job in processing_jobs:
        ...
        for input_dir in job['input_dirs']:
