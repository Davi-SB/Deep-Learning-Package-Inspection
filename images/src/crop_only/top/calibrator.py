...
cv2.createTrackbar('Contraste (x10)', 'Trackbars', 10, 50, do_nothing) # 1.0 a 3.0
cv2.createTrackbar('Brilho', 'Trackbars', 50, 500, do_nothing) # -50 a 50
cv2.createTrackbar('Saturacao (x10)', 'Trackbars', 10, 100, do_nothing) # 1.0 a 3.0
