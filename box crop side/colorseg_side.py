...
def crop_box_with_margin(image_path):
    ...
    SATURACAO_FACTOR = 2.4 # Valor 24 / 10.0
    MORPH_KERNEL = 7
    MORPH_ITERATIONS = 0   # Sem iterações de fechamento
    ...
    # Salva o resultado
    cv2.imwrite("output_final_cropped_box.png", cropped_box)
    ...
    cv2.imwrite("output_debug_crop_area.png", debug_image)
